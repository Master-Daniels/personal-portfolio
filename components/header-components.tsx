	...
	return (
		...
		>
			<Link
				...
				className={clsx(
					"w-full grid place-items-center py-3 px-4 hover:text-gray-950 hover:underline transition duration-700 dark:text-white",
					{
						"text-white": name === activeSection,
					},
				)}
				href={hash}
			>
				...
				{name === activeSection && (
					<motion.span
						...
						className="bg-gradient-to-r from-rose-500 to-purple-500 rounded-full absolute inset-0 -z-10"
					></motion.span>
				)}
			</Link>
		</motion.li>
