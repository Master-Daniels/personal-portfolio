...
export default function ProjectCard({ title, description, tags, imageUrl, link }: ProjectCardProps) {
	...
	return (
		...
		>
			<section className=" bg-gray-100 max-w-[54rem] border border-black/5 sm:pr-8 relative overflow-hidden sm:[h-20rem] md:[h-auto] rounded-lg hover:bg-gray-200 transition dark:bg-white/10 dark:hover:bg-white/20 dark:text-white ">
